    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] py-12 px-4 text-center max-w-xl mx-auto space-y-6 animate-fadeIn">
      ...
      <div className="pt-2 flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        <button
          ...
          className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-white hover:bg-slate-50 border border-slate-300 text-slate-800 font-extrabold text-xs shadow-2xs transition-all flex items-center justify-center space-x-2.5 group"
        >
        ...
        <button
          onClick={onOpenAuthModal}
          className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-[#0144e4] hover:bg-[#0035b5] text-white font-extrabold text-xs shadow-md shadow-blue-500/20 transition-all flex items-center justify-center space-x-2.5"
        >
