    ...
    <aside className="w-80 flex-shrink-0 bg-white border-r border-slate-200 min-h-screen flex flex-col justify-between p-5 shadow-sm z-30">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-3 cursor-pointer pt-1" onClick={() => setActiveTab('dashboard')}>
          <div className="w-9.5 h-9.5 rounded-xl bg-[#0144e4] text-white flex items-center justify-center font-bold shadow-md shadow-blue-500/20">
          ...
          <div>
            <div className="flex items-center space-x-1">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-[#0144e4] bg-blue-50 px-1.5 py-0.5 rounded font-mono border border-blue-100">Vault</span>
            </div>
        ...
        {currentUser && (
          <div className="relative animate-fadeIn">
            ...
            <button
              ...
              className="w-full p-2.5 rounded-2xl bg-blue-50/80 hover:bg-blue-100/80 border border-blue-200 text-left transition-all flex items-center justify-between shadow-xs"
            >
              <div className="truncate pr-2">
                <p className="text-xs font-extrabold text-slate-900 truncate">
                  {currentUser.discipline || 'Likeness & Voice Protection'}
                </p>
                <p className="text-[10px] font-bold text-[#0144e4] font-mono">
                  ● Module Active & Protected
                </p>
              </div>
              {isDisciplineDropdownOpen ? <ChevronUp className="w-4 h-4 text-[#0144e4] flex-shrink-0" /> : <ChevronDown className="w-4 h-4 text-[#0144e4] flex-shrink-0" />}
            </button>
              ...
              <div className="absolute left-0 right-0 top-full mt-2 z-50 bg-white border border-slate-200 rounded-2xl shadow-xl p-2 space-y-1 animate-fadeIn">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-2.5 py-2 rounded-xl text-xs font-bold flex items-center justify-between transition-all ${
                        isSelected
                          ? 'bg-[#0144e4] text-white font-extrabold'
                ...
                <div className="pt-1 border-t border-slate-100">
                  <button
                    ...
                    className="w-full text-left px-2.5 py-2 rounded-xl text-xs font-extrabold text-[#0144e4] bg-blue-50 hover:bg-blue-100 flex items-center space-x-2 transition-all border border-blue-200"
                  >
                    <Plus className="w-3.5 h-3.5 text-[#0144e4]" />
          ...
          <div className="p-3 bg-slate-50 border border-slate-200 rounded-2xl space-y-2.5">
            ...
            <div className="space-y-1">
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-bold transition-all ${
                  policyMode === 'micro_monetization'
                    ? 'bg-[#0144e4] text-white shadow-sm font-extrabold'
                    : 'text-slate-600 hover:bg-white hover:text-slate-900'
                }`}
              ...
              >
                ...
                {policyMode === 'micro_monetization' && <span className="w-2 h-2 rounded-full bg-white animate-pulse"></span>}
              </button>
            </div>
          </div>
        ) : (
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-3 rounded-xl text-xs transition-all ${
                  isActive
                    ? 'bg-[#0144e4] text-white font-extrabold shadow-md shadow-blue-500/20'
      ...
      <div className="pt-4 border-t border-slate-200 space-y-3">
        {currentUser ? (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2.5 truncate">
                ...
                <div className="text-left leading-tight truncate">
                  ...
                  <p className="text-[10px] text-[#0144e4] font-mono font-bold truncate">{currentUser.handle}</p>
                </div>
              </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-[#0144e4] hover:bg-[#0035b5] text-white font-extrabold text-xs shadow-md shadow-blue-500/20 transition-all flex items-center justify-center space-x-2"
          >
