        ...
        <div className="space-y-2.5">
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-800 border border-slate-200 text-xs font-bold flex items-center justify-center space-x-2 transition-all shadow-xs"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold flex items-center justify-center space-x-2 transition-all shadow-xs font-mono"
            >
          ...
          <div className="relative flex items-center justify-center pt-1">
            ...
            <span className="bg-white px-2.5 text-[10px] font-bold text-slate-400 uppercase font-mono tracking-wider absolute">Or Email</span>
          </div>
        </div>
